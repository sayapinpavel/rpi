...
14. Скачайте скрипт https://github.com/sayapinpavel/rpi/blob/main/get_img.sh и подожите его на rpi в домашнию директорию
...
16. Проинициализируйте драйвер который в скинули на rpi: insmod ov5647.ko 
